...
class UsuariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create usuario" do
    assert_difference('Usuario.count') do
      post usuarios_url, params: { usuario: { email: @usuario.email, nombre_usuario: @usuario.nombre_usuario } }
    end
  ...
  test "should update usuario" do
    patch usuario_url(@usuario), params: { usuario: { email: @usuario.email, nombre_usuario: @usuario.nombre_usuario } }
